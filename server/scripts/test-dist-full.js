...
async function testDistance() {
  ...
  console.log(`FEMALE: ${femalePet.name} | Loc: ${femalePet.location} | GPS: ${femalePet.latitude}, ${femalePet.longitude}`);
  console.log(`Resolved fCoords:`, getProvinceCoords(femalePet.location));
  ...
  for (const candidate of candidates) {
      ...
      console.log(`[${candidate.name}] Loc: ${candidate.location} | candGPS: ${candLat},${candLng} | distanceKm: ${distanceKm}`);
  }
}

testDistance().finally(() => prisma.$disconnect());
